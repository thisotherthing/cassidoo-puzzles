...
Deno.test("truncate", () => {
  ...
  assertEquals(truncate('never gonna give you up', 3), 'nev gon giv you up');
  assertEquals(truncate('*hello* darkness, my ~old_friend', 3), '*hel* dar, my ~old_fri');
  assertEquals(truncate('*hello* darkness, my ~old_friend', 2), '*he* da, my ~ol_fr');
  assertEquals(truncate('*hello* darkness, my ~old_friend', 1), '*h* d, m ~o_f');
});
